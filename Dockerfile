...
RUN apt-get update
RUN DEBIAN_FRONTEND=noninteractive apt-get -y install nano sudo gnupg lsb-release ca-certificates tzdata awscli cron
...
RUN cp ./mongodb.cron /etc/cron.d/mongodb
